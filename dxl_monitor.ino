...
void setup()
{
   ...
   CMD_SERIAL.begin(115200);   //set debugging port baudrate to 115200bps
    while(!CMD_SERIAL);         //Wait until the serial port is opened
      CMD_SERIAL.printf("Error CMD_SERIAL\n");
}
